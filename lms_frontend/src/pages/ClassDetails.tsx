                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            disabled={loading}
                            className="px-4 py-2 bg-gray-100 text-gray-700 rounded-xl flex items-center gap-2 hover:bg-gray-200 disabled:opacity-50 font-medium shadow-sm transition-all"
                        >
